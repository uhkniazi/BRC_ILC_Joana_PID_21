...
setwd('dataExternal/remoteData/raw/')
...
setwd(gcswd)
n = make.names(paste('CFastqQualityBatch data id 42 joana rds'))
...
df = data.frame(idData=g_did, name=n, type='rds', location='~/Data/MetaData/', comment='pre trim FASTQ quality checks on Joana mouse data')
